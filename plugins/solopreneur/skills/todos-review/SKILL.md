...
description: |
  ...
  Dispatches platform-specific expert agents for readiness checks. Use when
...
Review a todo or backlog item to evaluate problem clarity, solution quality, and
