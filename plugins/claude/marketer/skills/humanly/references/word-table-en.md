...
> **Adding or changing a word → edit this file only** (pick the tier first), then run `python3 scripts/build-prewrite.py` to regenerate the prewrite file.
> **Who reads me**: rewrite / review mode reads this file in full; prewrite mode reads `generated/prewrite-en.md` (the script extracts Tier 1 from here automatically — never hand-copy entries elsewhere).
...
Source: [avoid-ai-writing](https://github.com/conorbronsdon/avoid-ai-writing) v3.3.0 by Conor Bronsdon (MIT License)
