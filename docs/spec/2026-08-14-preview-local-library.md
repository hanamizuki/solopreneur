...
Re-run in the prior spec's format against isolated consumer installs:
library-mode creation and build with hashes and sentinel checks, ephemeral
delivery, and explicit-Vercel fail-closed with no side effects, per
surface.
