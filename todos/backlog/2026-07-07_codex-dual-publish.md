...
- [ ] Revalidate the Codex CLI and Codex bot final-gate recipes under the new exact-target contract with paired clean and seeded-bug fixtures. Internal Codex review and historical bot success cannot substitute for these external recipe gates.
- [ ] Calibrate Bugbot with paid opt-in clean and seeded-bug PR fixtures. Until identity, completion, positive zero-finding signal, finding parser, and exact-head binding all pass, treat Bugbot as unavailable and use Claude CLI.
