...
| [`/humanly`](./plugins/marketer/skills/humanly/SKILL.md) | **Editor.** Removes AI writing patterns from text: 37 pattern categories, 3-tier word tables, severity-based audit (P0/P1/P2), with English and Traditional Chinese support |
